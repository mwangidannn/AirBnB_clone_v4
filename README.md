...
its a  full-stack web application, integrating a MySQL database and Flask RESTful API with a dynamic HTML5/CSS3/jQuery front-end.
...
The endpoints can be seen below.
    ...
    **Retrieves all Place objects depending of the JSON in the body of the request.
    ...
    GET /apidocs
    **Gets the documentation of the API built in# Challenges and Future Features
